...
router.get("/account-settings", controller.accountSettings);
router.patch("/account-settings/profile", controller.updateAccountProfile);
router.patch("/account-settings/preferences", controller.updateAccountPreferences);
router.patch("/account-settings/password", controller.changeAccountPassword);
router.get("/orders", controller.orders);
router.get("/storage", controller.storage);
router.get("/virtual-nfc-designs", controller.listVirtualNfcDesigns);
router.post("/virtual-nfc-designs", controller.createVirtualNfcDesign);
router.patch("/virtual-nfc-designs/:id", controller.updateVirtualNfcDesign);
router.delete("/virtual-nfc-designs/:id", controller.deleteVirtualNfcDesign);
